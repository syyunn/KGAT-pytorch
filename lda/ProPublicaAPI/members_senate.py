...
df = df[['congress', 'chamber', 'fec_candidate_id', 'id', 'first_name', 'middle_name', 'last_name', 'gender', 'date_of_birth', 'state']]

print(list(df))
if __name__ == "__main__":
    conn = create_connection()
    copy_from_stringio(conn=conn, df=df, table='prorepublica.members_senate')
    pass
